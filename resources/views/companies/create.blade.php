                                        ...
                                        <form action="{{route('Companies.store')}}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                 {{-- <div class="form-group col">
                                                    ...
                                                    <input name="company_code" type="text" class="form-control" id="hospitalCode"
                                                        aria-describedby="emailHelp" placeholder="ادخل رمز الشركة">
                                                </div>  --}}
                                                <div class="form-group col">
                                                    <label for="hospitalName">اسم الشركة</label>
                                                    <input name="company_name" type="text" class="form-control" id="hospitalName"
                                            ...
                                            <div class="row"><br>
                                                ...
                                                <div class="col">
                                                    ...
                                                    {{-- <input name="services" type="text" class="form-control" placeholder="الخدمات " id="services"> --}}
                                                    ...
                                                    <span class="text-red">    @error('services')    {{$message}} @enderror </span>
                                                </div>
                                            </div>
                                            <br>
                                            <div class="row">

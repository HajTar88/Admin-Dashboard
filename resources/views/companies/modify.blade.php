                                        ...
                                        <form action="{{route('Companies.update', $companies->id)}}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                {{-- <div class="form-group col-sm-6">
                                                    <label for="hospitalCode">رمز الشركة</label>
                                                    <input name="company_code" value="{{$companies->company_code}}"  type="text" class="form-control" id="hospitalCode"
                                                        aria-describedby="emailHelp" placeholder="ادخل رمز الشركة">
                                                </div> --}}
                                                <div class="form-group col">
                                                    <label for="hospitalName">اسم الشركة</label>
                                                    <input name="company_name" value="{{$companies->company_name}}" type="text" class="form-control" id="hospitalName"
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    ...
                                                    <input name="address" value="{{$companies->address}}" type="text" class="form-control" placeholder="العنوان ">
                                                    <span class="text-red">    @error('address') <strong>{{ $message }}</strong> @enderror </span>
                                                </div>
                                                <div class="col">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    <label for="hospitalName"> الخدمات</label>
                                                    {{-- <input name="services" value="{{$companies->services}}" type="text" class="form-control" placeholder="الخدمات "> --}}
                                                    <select name="services"  class="form-control"  id="services">
                                                        <option value="صيانة" >صيانة</option>
                                                        <option value="لوجيستسة" >لوجيستسة</option>
                                                        <option value="خدمات ما بعد البيع" >خدمات ما بعد البيع</option>
                                                    </select>
                                                </div>
                                            </div><br>
                                            <div class="row">

                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="tab-content p-0">
                                        <!-- Morris chart - Sales -->
                                        <form action="{{route('hospitals.update' ,  $hospitals->id)}}" method="POST" enctype="multipart/form-data" >
                                            @csrf
                                            @method('PUT')
                                            <div class="row">
                                                {{-- <div class="form-group col">
                                                    <label for="hospitalCode">رمز المستشفى</label>
                                                    <input type="text" value="{{$hospitals->hospital_code}}" name="hospital_code" class="form-control" id="hospitalCode" aria-describedby="emailHelp" placeholder="ادخل رمز المستشفى">
                                                    <span class="text-red">    @error('hospital_address') <strong>{{ $message }}</strong> @enderror </span>
                                                </div> --}}
                                                <div class="form-group col">
                                                    <label for="hospitalName">اسم المستشفى</label>
                                                    <input type="text" value="{{$hospitals->hospital_name}}" name="hospital_name" class="form-control" id="hospitalName"
                                            ...
                                            <div class="row">
                                                <div class="form-group col">
                                                    ...
                                                    <input name="photo" value="{{$hospitals->photo}}" type="file" class="form-control" placeholder="المنتجات ">
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    ...
                                                    <input type="text" value="{{$hospitals->hospital_address}}"  name="hospital_address" class="form-control" placeholder="العنوان ">
                                                    <span class="text-red">    @error('hospital_address') <strong>{{ $message }}</strong> @enderror </span>
                                                </div>
                                                <div class="col">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    ...
                                                    <input id="password" type="password" name="password_confirmation" class="form-control  @error('password') is-invalid @enderror " placeholder="تأكيد كلمة المرور" >
                                                </div>
                                                </div><br>
                                            <div class="row">
                                                <div class="col">
                                                    <button class="btn btn-primary">تعديل <i class="bi bi-plus-circle"></i></button>
                                                </div>
                                                <div class="col">
